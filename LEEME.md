...
Las siguientes son algunas características del desarrollo dignas de mencionar:
 ...
 - La aplicación cliente is una aplicación de una sola página como es esperado de las aplicaciones AngularJS
 ...
 - El servidor envía una descripción exhaustiva de la api cuando se acceden rutas desconocidas precedidas de `/api`. Esto se puede considerar como documentación, lo que facilita el entendimiento de como usar la api. :star:
